...
<head>
  ...
  <nav class="navbar navbar-expand-md navbar-dark bg-dark fixed-top">
             ...
             <!-- Brand/logo -->
                     <a class="navbar-brand" href="#" style="color: rgb(231, 94, 31);">
                     <img src="Images/fd.jpg" alt="logo" style="width:60px;"> Dolly-FOS </a> 
                     ...
                     <div class="carousel-inner" role="listbox">
                       ...
                       -webkit-filter: blur(5px);"></div>
                        <div class="carousel-caption text-center">
                          <h1 class="display-4">Welcome to Dolly-FOS</h1>
...
<p class="text-center w-responsive mx-auto mb-5">If You have any questions, please do not hesitate to contact us directly. Answer usually foloows within few hours.</p>
...
<div class="row">
    ...
    <div class="col-md-3 text-center">
      ...
      <div class="social-img" >
          <a class="fb-ic mr-3" role="button" href="https://m.facebook.com/"><i class="fab fa-lg fa-facebook-f"></i>acebook</a>
          <a class="ins-ic mr-3" role="button" href="https://www.instagram.com/"> Instagram<i class="fab fa-lg fa-instagram"></i></a>
      </div>
